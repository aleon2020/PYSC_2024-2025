...
(:init
  ...
  (= (locations_distance limonero1 limonero2) 5)
  (= (locations_distance limonero2 limonero1) 5)
  (= (locations_distance limonero2 base) 5)
  (= (locations_distance base limonero2) 5)
  (= (locations_distance limonero3 limonero4) 5)
  (= (locations_distance limonero3 base) 5)
  (= (locations_distance limonero4 limonero3) 5)
  (= (locations_distance limonero4 base) 5)
  (= (locations_distance limonero5 base) 5)
  (= (locations_distance base limonero3) 5)
  (= (locations_distance base limonero4) 5)
  (= (locations_distance base limonero5) 5)
  (= (locations_distance base Large-Deposit) 10)
  (= (locations_distance limonero1 Large-Deposit) 10)
  (= (locations_distance limonero2 Large-Deposit) 10)
  (= (locations_distance limonero3 Large-Deposit) 10)
  (= (locations_distance limonero4 Large-Deposit) 10)
  (= (locations_distance limonero5 Large-Deposit) 10)
  (= (locations_distance Large-Deposit limonero1) 10)
  (= (locations_distance Large-Deposit limonero2) 10)
  (= (locations_distance Large-Deposit limonero3) 10)
  (= (locations_distance Large-Deposit limonero4) 10)
  (= (locations_distance Large-Deposit limonero5) 10)
